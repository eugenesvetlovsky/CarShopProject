...
# Для продакшена используйте настройки ниже (раскомментируйте и настройте):
# EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
# EMAIL_HOST = get_env('EMAIL_HOST', 'smtp.gmail.com')
# EMAIL_PORT = int(get_env('EMAIL_PORT', '587'))
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = get_env('EMAIL_HOST_USER', 'your-email@gmail.com')
# EMAIL_HOST_PASSWORD = get_env('EMAIL_HOST_PASSWORD', 'your-app-password')
DEFAULT_FROM_EMAIL = get_env('DEFAULT_FROM_EMAIL', 'noreply@carshop.com')
